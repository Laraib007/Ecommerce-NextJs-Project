    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <div class="flex text-center mb-4">
          <a class="flex-grow text-pink-500 border-b-2 border-pink-500 py-2 text-lg px-1 mr-40">Description</a>
          <a class="flex-grow text-pink-500 border-b-2 border-pink-500 py-2 text-lg px-1 mr-6">Qty</a>
