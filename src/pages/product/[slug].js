    ...
    <Image alt="ecommerce" width={380} height={100} class=" border-2 object-cover object-center rounded " loader={() => src} src={src}></Image>
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex">
          ...
          <button onClick={addToCart(productSlug, product.title, product.price, 1, size, color)} class="flex ml-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded"><IoBagCheck className='text-sd mt-1 mr-1 ' />Buy Now</button>
