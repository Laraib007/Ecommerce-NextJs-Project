...
const Slugs =()=> {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto md:w-full h-74 object-cover object-center rounded p-20" src="https://m.media-amazon.com/images/I/71o36DccmvL.__AC_SX300_SY300_QL70_FMwebp_.jpg" />
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex">
          ...
          <button class="flex ml-3 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
