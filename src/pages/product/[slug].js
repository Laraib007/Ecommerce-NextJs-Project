    ...
    <Image alt="ecommerce" width={380} height={100} class=" border-2 object-cover object-center rounded " loader={() => src} src={src}></Image>
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex">
          ...
          <button onClick={()=>addToCart(Slugs, "Wear the Code", 499, "XL", "Blue")} class="flex ml-3 text-white bg-pink-500 border-0 py-2 px-3 focus:outline-none hover:bg-pink-600 rounded"><FaCartShopping className='text-sd mt-1 mr-1 cursor-pointer text-white ' />Add to Cart</button>
