...
<div id="controls-carousel" class="relative w-full" data-carousel="static">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class=" duration-700 ease-in-out" data-carousel-item>
            <Image src={slider1} height={100} width={100} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
        </div>
        {/* <!-- Item 2 --> */}
        <div class=" duration-700 ease-in-out" data-carousel-item="active">
            <Image src={slider2} height={100} width={100} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
        </div>
        {/* <!-- Item 3 --> */}
        <div class=" duration-700 ease-in-out" data-carousel-item>
            <Image src={slider3} height={100} width={100} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
        </div>
        {/* <!-- Item 4 --> */}
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <Image src="/docs/images/carousel/carousel-4.svg" height={100} width={100} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
        </div>
        {/* <!-- Item 5 --> */}
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <Image src="/docs/images/carousel/carousel-5.svg" height={100} width={100} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
        </div>
    </div>
    {/* <!-- Slider controls --> */}
